...
const SettingsPane = props => {
    ...
    return (
        <div className="settings">
            ...
            <p id="settingsTimeLimit" className="settings-item settings-item-name" onClick={props.handleChange}>Time Limit Per Round <span id="timeLimitValue" className="settings-item-value">{props.timeLimit} sec<span id="timeLimitCarat" className="carat">></span></span></p>
            <p id="settingsRounds" className="settings-item settings-item-name" onClick={props.handleChange}>Rounds <span id="roundsValue" className="settings-item-value">{props.rounds}<span id="roundsCarat" className="carat">></span></span></p>
            </div>
            <p></p>
